...
const PlayerBottom = ({ songs, currentIndex, setCurrentIndex }) => {
    ...
    return (
        <div className='bg-[#1A1824] relative'>
            ...
            <div 
                className={`
                    h-[15vh] w-full bg-black transition-all duration-500 ease-in-out
                    ${playerExpanded ? 'translate-y-0' : 'translate-y-0'}
                `}
            >
                <div className="h-full flex items-center gap-4 px-3">
                    ...
                    <div className="flex-1 min-w-0">
                        {currentSong && (
                            <>
                                <h1 className="text-white font-bold truncate">{currentSong.title}</h1>
                                <p className="text-gray-300 text-[11px] truncate">{currentSong.artist}</p>
                            </>
                        )}
                    </div>
